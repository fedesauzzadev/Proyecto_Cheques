...
namespace IrmaRios.Cartera.Application.Common;

/// <summary>Reglas de paginación compartidas (mismo contrato que el ecosistema).</summary>
...
/// <summary>Hash SHA-256 del body para detectar reuso de Idempotency-Key con otro payload.</summary>
